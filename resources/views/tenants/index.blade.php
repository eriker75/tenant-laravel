<x-app-layout>
    ...
    <div class="container max-w-7xl mx-auto mt-8" style="max-width: 1000px">
        <div class="mb-4">
          <div class="flex justify-end">
            <a class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600" href="{{route('tenants.create')}}">Create Tenant</a>
          </div>
        </div>
